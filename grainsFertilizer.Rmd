...
colnames(countryData)[1] = "Country.Name"
colnames(actualData)[1] = "Country.Name"
actualData = actualData[which(actualData$Country.Code %in% countryData$Country.Name),]
...
data = merge(fertilizer, cerealProduction, by=c("Country.Name", "Country.Code", "Year"))
